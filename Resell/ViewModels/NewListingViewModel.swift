        ...
        Task {
            ...
            do {
                if let user = GoogleAuthManager.shared.user {
                    ...
                    let postBody = PostBody(title: titleText, description: descriptionText, categories: [selectedFilter], originalPrice: Double(priceText) ?? 0, imagesBase64: imagesBase64, userId: user.firebaseUid)
