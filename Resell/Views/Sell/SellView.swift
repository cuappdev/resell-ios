...
//                if viewModel.selectedFilter == "Clothing" {
        ...
        formSection(title: "Category") {
            HFlow {
                ForEach(categoryOptions, id: \.self) { category in
                    selectionChip(
                        title: category == "Handmade" ? "Homemade" : category,
    ...
    private var additionalDetailsSection: some View {
        formSection(title: "Additional Details") {
            LazyVGrid(
                ...
                detailField("Clothing Brand", systemName: "magnifyingglass")
                detailField("Tops", systemName: "chevron.down")
                detailField("Size", systemName: "chevron.down")
                detailField("Sub-category", systemName: "chevron.down")
            }
        }
    }

    private func detailField(_ title: String, systemName: String) -> some View {
        HStack {
            Text(title)
                .font(Constants.Fonts.subtitle1)
        ...
        .overlay {
            RoundedRectangle(cornerRadius: 6)
                .stroke(Constants.Colors.secondaryGray, lineWidth: 1)
        }
        .accessibilityHint("Additional listing details are coming soon")
    }
